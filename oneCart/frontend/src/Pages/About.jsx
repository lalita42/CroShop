...
export const About = () => {
  return (
    <div className='w-[100vw] min:w-[100vw] min-h-[100vh] flex items-center justify-center flex-col bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px] pt-[80px]'>

<Titile text1={'ABOUT'} text2={'US'}/>
...
<p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'></p>
<p>modern shoppers-combining style, convenience, and affordability. Whether it's fashion, essentials, or trends, we bring everything you need to one trusted platform with fast delivery, easy returns, and a customer-first shopping experience you'll love.</p>
...
<Titile text1={'WHY'} text2={'CHOOSE US'}/>
...
</div> <div className='lg:w-[33%] w-[90%] h-[250px] border-[1px] border-gray-100 flex items-center justify-center gap-[20px] flex-col px-[40px] py-[10px] text-[white] backdrop-blur-[2px] ☐ bg-[#ffffff0b]'>
